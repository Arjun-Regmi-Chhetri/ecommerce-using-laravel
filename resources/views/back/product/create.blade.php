...
@section('content')
    ...
    <div class="profile" style="margin: 10px 20px;">
        ...
        <div class="container-fluid">
            <form action="{{route('back.product.store')}}" method="POST" class="pt-3 pb-3" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="mb-3">
                    <div class="row">
                        <div class="col">
                            <label for="title" class="form-label">Title <span class="fs-5 fw-semibold text-success">*</span></label>
                            <input type="text" class="form-control" name="name" id="title" value="{{old('title')}}" placeholder="Enter title"  required>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <textarea name="description" class="form-control" value="{{old('description')}}" placeholder="" id="description"  style="height: 100px"></textarea>
                        ...
                        <div class="col">
                            ...
                            <div class="form-floating">
                                <textarea name="summary" class="form-control" value="{{old('summary')}}" placeholder="" id="summary"  style="height: 100px"></textarea>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="price" class="form-control" aria-label="Amount (to the nearest dollar)" id="price" value="{{old('price')}}">
                            ...
                            <div class="col">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">$</span>
                                    <input type="number" name="discount_price" class="form-control" aria-label="Amount (to the nearest dollar)" id="discount_price" value="{{old('discount_price')}}">
                                    <span class="input-group-text">.00</span>
                                </div>
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col">
                                ...
                                <input type="number" name="stock_qty" class="form-control" value="{{old('stock_qty')}}" id="stock_qty" placeholder="Enter stock Qty.">
                        </div>
                        <span class="text-danger">@error('stock_qty') {{$message}}  @enderror</span>
                        <div class="col">
                            <label for="category_id" class="form-label mb-3">Category Id <span class="fs-5 fw-semibold text-success">*</span></label>
                            <select class="form-select" aria-label="category_id" id="category_id" name="category_id">
                                @foreach($categories as $key => $category)
                                    <option value="{{$key}}"  {{old('category_id')==$key ? 'selected': ' '}} required>{{$category}}</option>
                                @endforeach
                        ...
                        <div class="col">
                            ...
                            <select class="form-select" aria-label="brand_id" id="brand_id" name="brand_id">
                                @foreach($brands as $key => $brand)
                                    <option value="{{$key}}" {{old('brand_id')==$key ?'selected': ''}} required>
                                        {{$brand}}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select"  name="featured" id="featured" aria-label="Default select example">
                        <option value="Yes" {{old('featured')}} >Yes</option>
                        <option value="No" {{old('featured')}}>No</option>
                    </select>
                </div>
                <div class="mb-3">
